...
3. The exact `dpkg` 1.22.6 fallback uses the official maintainer GitHub mirror and checks the full equivalent Salsa tag commit (`b2f9600…`) after clone. Fresh same-run candidate [`34241766195`](https://github.com/Anonymous1362/Arena-AI-PROJ/actions/runs/34241766195), commit `2064665`, passed arm64 source bootstrap, Android bundled-runtime installation validation, and personal arm64 APK construction. Its `Copper-runtime-device-candidate` artifact (ID `10067075336`, GitHub artifact-envelope SHA-256 `d857958f25da53e6c36e8774b3690c8b80604f99cb93f1b8b7e21b42de98b2ad`) is the **only** artifact eligible for Phase 0 physical testing.
